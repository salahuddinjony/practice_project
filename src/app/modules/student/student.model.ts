...
export const userNameSchema = new Schema<userName>(
  {
    firstName: {
      ...
      validate: {
        ...
        message:
          "{VALUE} is not a valid first name. First name should contain only letters.",
      },
    },
    middleName: {
      type: String,
      ...
      validate: {
        ...
        message:
          "{VALUE} is not a valid middle name. Middle name should contain only letters and numbers.",
      },
    },
    lastName: {
      type: String,
      ...
      validate: {
        ...
        message:
          "{VALUE} is not a valid last name. Last name should contain only letters and numbers.",
      },
...
export const guradianSchema = new Schema<guradian>(
  {
    ...
    fatherContactNo: {
      type: String,
      validate: {
        validator: (value: string) => validator.isMobilePhone(value, "bn-BD"),
...
const studentSchema = new Schema<Student>(
  {
    ...
    gender: {
      ...
      enum: {
        ...
        message:
          "'{VALUE}' is not a valid gender. Gender must be one of 'male', 'female', or 'other'.",
      },
      trim: true,
